...
// introspect token
export const INTROSPECT_REQUEST = 'INTROSPECT_REQUEST';
export const INTROSPECT_RESPONSE = 'INTROSPECT_RESPONSE';
export const INTROSPECT_FAILED = 'INTROSPECT_FAILED';